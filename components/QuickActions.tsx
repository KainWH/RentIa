...
const actions: Action[] = [
  { label: "Pedidos",    href: "/orders",    icon: ShoppingCart, color: "text-orange-600 dark:text-orange-400", bg: "bg-orange-100 dark:bg-orange-900/30 group-hover:bg-orange-200 dark:group-hover:bg-orange-900/50" },
